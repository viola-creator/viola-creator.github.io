...
'tea-dye': {
    ...
    'fact1':('The bags','One small and one large kinchaku-bukuro, made with 100% cotton and including wamen details.'),
    'fact2':('Yours the same day','Your bags will need a day to dry, but you get to take them home once the workshop ends, packed in waterproof material.'),
    ...
    'fact1_jp':('巾着袋','大小の巾着袋を1つずつ。100%コットンで、和紋のディテール入り。'),
    'fact2_jp':('当日お持ち帰り','巾着袋は完全に乾くまで1日ほどかかりますが、ワークショップ終了後にそのままお持ち帰りいただけます。防水素材で包んでお渡しします。'),
    'fact3_jp':('地球にやさしく','化学染料は一切使用しません。茶葉が持つ自然の抗菌作用により、日々の小物を収納するのにも最適です。'),
    'takehome_img':'images/take-home.jpg',
    'spend_steps':[
        ('i.','Welcome tea','You\'re greeted at the atelier with a seasonal cup of tea, and a warm introduction to the day.','images/003.jpeg'),
    ...
    'spend_steps_jp':[
        ('i.','ウェルカムティー','アトリエにて季節のお茶でお迎えし、本日の流れを丁寧にご案内いたします。',''),
    ...
    'faq_jp':[
      ('キャンセル規定について教えてください。', '開催日の7日前までは全額返金いたします。開催日の7日以内のキャンセルにつきましては、返金はいたしかねます。'),
...
'botanical-teas': {
    ...
    'craft_p2':'These botanical teas mirror the climate and the season, support physical and mental health, and tell the long story of Japanese agriculture and place. In this workshop, you\'ll smell, touch, and taste a selection of regional ingredients, then blend a tea that\'s entirely your own.',
    ...
    'takehome_lede':'You leave with a personal tea blend made by your own hands, with the season\'s ingredients, ready to brew at home.',
    ...
    'takehome_img':'images/take-home.jpg',
    'spend_steps':[
        ('i.','Welcome tea','A seasonal cup of tea on arrival, and a warm introduction to the day\'s ingredients.','images/003.jpg'),
        ('ii.','Smell · touch · taste','Get to know a variety of different herbs, foraged from Nara, to Miyazaki, and all the way to Okinawa.','images/004.jpg'),
    ...
    'spend_steps_jp':[
        ('i.','ウェルカムティー','到着後、季節のお茶を一杯。本日扱う素材について丁寧にご紹介いたします。',''),
        ('ii.','香り・触れ・味わう','奈良から宮崎、そして沖縄まで――各地で採れた多彩なハーブに、ひとつひとつ向き合っていただきます。',''),
    ...
    'faq':[
      ...
      ('What should I bring?', "You don't need to bring anything. All materials and ingredients will be provided."),
      ('Is the workshop bilingual?', 'No, the workshop will be conducted in English, with some Japanese if necessary.'),
      ('Do you accommodate private workshops?', "Please contact atelier@maana.jp with the number of participants and the dates you'll be visiting."),
    ],
    'faq_jp':[
      ...
      ('持ち物について教えてください。', '特にご用意いただくものはございません。材料・道具一式はすべてこちらでご用意いたします。'),
      ('バイリンガル対応はしていますか。', 'ワークショップは基本的に英語で進行いたします。必要に応じて日本語でもご説明いたします。'),
      ('貸切のワークショップに対応していますか。', 'ご希望の人数とご来訪日を添えて、atelier@maana.jpまでご連絡ください。'),
    ],
},
'koji-fermentation': {
    ...
    'craft_p1':'Shoyu, sake, mirin, miso — the staples of the Japanese table, all built on a single quiet foundation: <em>koji</em>, the national mould of Japan. Inoculated onto rice, barley, or soy, koji is the starter that turns ingredients into the fermented umami the islands are known for.',
    'craft_p1_jp': '醤油、日本酒、味醂、味噌――日本の食卓を支える調味料はみな、ひとつの静かな存在に支えられています。それが<em>麹（こうじ）</em>、日本の「国菌」です。米や麦、大豆に種付けされる麹こそが、素材を日本ならではのうま味へと変えてくれる発酵の出発点です。',
    'craft_p2':'In this workshop, you\'ll learn all about koji and how its use evolves across the Japanese archipelago, giving rise to different flavours and effects. Then, make two personalized condiments for your own pantry: shoyu-koji rich with dried fruit, and shio-koji with aromatic spices.',
    'craft_p2_jp': '本ワークショップでは、麹について、そして日本各地で麹の使い方がどのように発展し、それぞれの風味や効能を生んできたのかを学んでいただきます。その後、ご自分用の調味料を2瓶仕込んでいただきます。ドライフルーツの香る醤油麹、そして香辛料を効かせた塩麹。',
    'craft_img':'images/001.jpg',
    'takehome_lede':'You leave with two jars of koji condiments to ferment over time, building depth and flavour that finishes on your kitchen counter.',
    'takehome_lede_jp': '麹の調味料を2瓶。ご自宅のキッチンカウンターでゆっくりと発酵が進み、深みと風味が育っていきます。',
    'fact1':('Two jars','Shoyu-koji and shio-koji, with dried fruit and aromatic spices.'),
    ...
    'fact3':('Better cooking','One spoonful turns a bowl of rice, a piece of fish, or a salad dressing into something flavourful and gut-enriching.'),
    'fact1_jp':('2つの瓶','醤油麹と塩麹を1瓶ずつ。ドライフルーツと香り高いスパイスを合わせて。'),
    'fact2_jp':('数日でできあがり','ご自宅で7〜14日ほどさらに発酵を進め、その後は冷蔵庫で保存してお使いください。'),
    'fact3_jp':('日々の料理に','ひとさじでご飯、魚、サラダのドレッシングが、滋味豊かで腸にやさしい一品に変わります。'),
    'takehome_img':'images/take-home.jpg',
    'spend_steps':[
        ...
        ('iii.','Mix','Combine koji with salt, soy sauce, dried fruit, and aromatic spices. Try your hand at creating two unique flavours.','images/006.jpg'),
        ('iv.','Bottle','Ingredients go into a compact glass jar. Shake to mix and let the ingredients get to know each other, then label and pack for the journey home.','images/007.jpeg'),
    ],
    'spend_steps_jp':[
        ('i.','ウェルカムティー','到着後、季節のお茶を一杯。日本各地の発酵文化について丁寧にご紹介いたします。',''),
        ('ii.','麹に出会う','米麹の香りと手触りを確かめます。味噌・醤油・酒の源となるその力に触れ、麹を使った調味料を少しずつ味わっていただきます。',''),
        ('iii.','仕込む','塩、醤油、ドライフルーツ、香り高いスパイスを麹と合わせていきます。それぞれに個性のある2つの調味料を仕込んでみましょう。',''),
...
'morning-tea': {
    ...
    'spend_steps':[
        ...
        ('iii.','Wagashi · matcha','The ceremony unfolds. Observe how the tea is thoughtfully prepared, with a matcha bowl selected just for you.','images/006.jpg'),
    ...
    'spend_steps_jp':[
        ...
        ('iii.','和菓子・抹茶','茶の湯が始まります。あなたのために選ばれた一椀で、心を込めて点てられる所作をご覧ください。',''),
